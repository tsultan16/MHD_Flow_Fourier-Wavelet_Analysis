...
INTEGER, PARAMETER :: ndumps = 120
INTEGER, PARAMETER :: nbegin = 0 !0
INTEGER, PARAMETER :: nskip = 5 !0
...
DO nd = nbegin, ndumps, nskip
   ...
   !##############################################################################################################
    ...
    PRINT*,'Mode decomposition time (sec)= ', t2a-t10
    ...
    DO iz = 1, nranks_z*nz
        DO iy = 1, nranks_y*ny
            DO ix = 1, nranks_x*nx
                ...
                ! Need to fiugure out a good way to compute this. Maybe average it over the wavelet funciton norm/magnitude?? 
