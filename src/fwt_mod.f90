...
SUBROUTINE compute_basis_wavelet(i,j,k,fx)
    ...
    REAL, INTENT(INOUT) :: fx(nx_tot,nx_tot,nx_tot)
    REAL, ALLOCATABLE :: fw(:,:,:)
    INTEGER :: ix, iy, iz
...
! this routine performs a 3d discrete wavelet transform of a scalar function
SUBROUTINE fwt_3d(fx, fw, sgn)
    ...
    INTEGER, INTENT(IN) :: sgn ! 1: dwt, -1: inverse dwt
